  ...
  $(document).ready(function() {
      ...
      function showErrorsForInput(input, errors) {
          ...
          var formGroup = closestParent(input.parentNode, "mb-3")
      ...
      function showErrorsForInput1(input, errors) {
          ...
          // This is the root of the input
          var formGroup = closestParent1(input.parentNode, "mb-3")
              // Find where the error messages will be insert into
              ,
              messages = formGroup.querySelector(".messages");
          // First we remove any old messages and resets the classes
      ...
      function showErrorsForInput2(input, errors) {
          ...
          // This is the root of the input
          var formGroup = closestParent2(input.parentNode, "mb-3")
              // Find where the error messages will be insert into
              ,
              messages = formGroup.querySelector(".messages");
          // First we remove any old messages and resets the classes
      ...
      function showErrorsForInput3(input, errors) {
          ...
          var formGroup = closestParent3(input.parentNode, "mb-3")
              // Find where the error messages will be insert into
              ,
              messages = formGroup.querySelector(".messages");
          // First we remove any old messages and resets the classes
